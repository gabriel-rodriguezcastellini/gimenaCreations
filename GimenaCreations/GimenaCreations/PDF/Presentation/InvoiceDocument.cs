using GimenaCreations.PDF.Components;
...
{    
    ...
    public InvoiceDocument(InvoiceModel model, IWebHostEnvironment webHostEnvironment)
    {
        Model = model;
    ...
    void ComposeHeader(IContainer container)
    {
        ...
        container.Row(row =>
        {
            ...
            row.ConstantItem(100).Height(50).Image($"{_webHostEnvironment.WebRootPath}\\Creaciones_gime.png", ImageScaling.FitArea);
        });
    }
